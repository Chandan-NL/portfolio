    ...
    (d.DEFAULTS = { imageUrl: null, resolution: 256, dropRadius: 20, perturbance: 0.03, interactive: !0, crossOrigin: "" }),
        (d.prototype = {
            ...
            computeTextureBoundaries: function () {
                ...
                if (
                    ("fixed" == o ? (((e = { left: window.pageXOffset, top: window.pageYOffset }).width = u.width()), (e.height = u.height())) : (((e = this.$el.offset()).width = this.$el.innerWidth()), (e.height = this.$el.innerHeight())),
                    "cover" == i)
                )
                    ...
                    t(s) ? (s = (e.width * parseFloat(s)) / 100) : "auto" != s && (s = parseFloat(s)),
                        ...
                        "auto" == s && "auto" == h
                            ...
                            : ("auto" == s && (s = this.backgroundWidth * (h / this.backgroundHeight)), "auto" == h && (h = this.backgroundHeight * (s / this.backgroundWidth)));
                }
                var c = n[0],
                    d = n[1];
