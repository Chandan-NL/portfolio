...
jQuery(document).ready(function () {
  ...
  ca_tm_modalbox();
  ca_tm_page_transition();
  ca_tm_trigger_menu();
  ca_tm_my_progress();
  ca_tm_circular_progress();
  ca_tm_portfolio_popup();
  ca_tm_news_popup();
  ca_tm_service_popup();
  ca_tm_cursor();
  ca_tm_imgtosvg();
...
function ca_tm_modalbox() {
  "use strict";

  jQuery(".ca_tm_all_wrap").prepend(
    '<div class="ca_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel"></i></a></div><div class="description_wrap"></div></div></div>'
  );
}
...
function ca_tm_page_transition() {
  "use strict";

  var section = jQuery(".ca_tm_section");
  var allLi = jQuery(".transition_link li");
  var button = jQuery(".transition_link a");
  var wrapper = jQuery(".ca_tm_all_wrap");
  ...
  button.on("click", function () {
    ...
    if (element.parent().hasClass("ca_tm_button")) {
...
function ca_tm_trigger_menu() {
  "use strict";

  var hamburger = jQuery(".ca_tm_topbar .trigger .hamburger");
  var mobileMenu = jQuery(".ca_tm_mobile_menu");
  var mobileMenuList = jQuery(".ca_tm_mobile_menu .menu_list ul li a");
  ...
  mobileMenuList.on("click", function () {
    jQuery(".ca_tm_topbar .trigger .hamburger").removeClass("is-active");
    mobileMenu.removeClass("opened");
    return false;
  });
}
...
function ca_tm_circular_progress() {
  "use strict";
...
function ca_tm_portfolio_popup() {
  "use strict";

  var modalBox = jQuery(".ca_tm_modalbox");
  var button = jQuery(".ca_tm_portfolio .portfolio_popup");
...
function ca_tm_news_popup() {
  "use strict";

  var modalBox = jQuery(".ca_tm_modalbox");
  var button = jQuery(".ca_tm_news .news_list > ul > li .post_title h3 a");
  var closePopup = modalBox.find(".close");
...
function ca_tm_service_popup() {
  "use strict";

  var modalBox = jQuery(".ca_tm_modalbox");
  var button = jQuery(".ca_tm_service .service_list ul li .ca_tm_full_link");
  var closePopup = modalBox.find(".close");
  ...
  if (myCursor.length) {
    if ($("body")) {
      ...
      (window.onmousemove = function (s) {
        ...
        $("body").on(
          "mouseenter",
          "a,.ca_tm_topbar .trigger, .cursor-pointer",
          function () {
...
function ca_tm_portfolio() {
  "use strict";

  if (jQuery().isotope) {
    // Needed variables
    var filter = jQuery(".ca_tm_portfolio .portfolio_filter ul");
...
function ca_tm_mycarousel() {
  "use strict";

  var carousel = jQuery(".ca_tm_about .testimonials .owl-carousel");
...
function hashtag() {
  "use strict";
  var ccc = $(".ca_tm_header .menu .ccc");
  var element = $(".ca_tm_header .menu .active a");
  $(".ca_tm_header .menu a").on("mouseenter", function () {
    var e = $(this);
    currentLink(ccc, e);
  });
  $(".ca_tm_header .menu").on("mouseleave", function () {
    element = $(".ca_tm_header .menu .active a");
...
function currentLink(ccc, e) {
  ...
  var menuleft = $(".ca_tm_header .menu").offset().left;
...
// function ca_tm_moving_box() {
//   "use strict";

//   var wrapper = $(".ca_tm_news");
//   var list = wrapper.find(".news_list > ul > li");
//   if (!$(".ca_fn_moving_box").length) {
//     $("body").append('<div class="ca_fn_moving_box"></div>');
//   }
//   var box = $(".ca_fn_moving_box");
